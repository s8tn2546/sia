...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      `}>
        {/* Logo */}
        <Link to="/" onClick={onClose} className="h-16 flex items-center px-6 border-b border-border hover:bg-bg-secondary transition-colors cursor-pointer decoration-transparent">
